...
<header id="masthead" class="site-header">
	<div class="header-logo">
		<a href="<?php echo esc_url( site_url() ); ?>">
			<img src="<?php echo esc_url( get_header_image() ); ?>" alt="header-logo" >
		</a>
	</div>
	<nav id="site-navigation" class="main-navigation">
		<!-- <button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Menu', 'ajinkya' ); ?></button> -->
		<?php
		wp_nav_menu(
			array(
